function [P, J] = regionGrowinggg(cIM, initPos,tfMean, tfFillHoles, tfSimplify)
% REGIONGROWING Region growing algorithm for 2D/3D grayscale images
%function [P, J] = regionGrowinggg(cIM, initPos, thresVal, maxDist, tfMean, tfFillHoles, tfSimplify)
