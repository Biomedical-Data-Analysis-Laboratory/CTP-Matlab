...
%
%  J = LBP(I,SP,MAPPING)% computes the LBP codes using n sampling
...
maske = imbinarize(image);
maske = maske(origy:origy+dy,origx:origx+dx);

result = bsxfun(@times, result, cast(maske, 'like', result));
