...
elseif isunix % unix sistem (gorina)
    ...
    perfusionCTFolder = "/home/student/lucat/PhD_Project/Stroke_segmentation/PATIENTS/SUS2020_v2/Parametric_maps/";
    saveFolder = "/home/student/lucat/PhD_Project/Stroke_segmentation/PATIENTS/SUS2020_TIFF/Thresholding_Methods/";
    workspaceFolder = strcat(MAIN_PATH, 'Workspace_thresholdingMethods/'); 
    SAVED_MODELS_FOLDER = strcat(MAIN_PATH, 'Workspace_thresholdingMethods/'); 
...
%% ML method
if ~THRESHOLDING
    constants.SUFFIX_RES = 'SVM'; % 'SVM' // 'tree' // 'randomForest' // naiveBayes
    ...
    constants.STEPS = 2; % or 2 steps to divide penumbra and core prediction1
...
%     researchesValues('Wintermark_2006') = struct('CBV', [33, "down", "core", ""], 'MTT', [80, "up", "core", ""], 'CBV_2', [33, "up", "penumbra", ""], 'MTT_2', [7.25, "up", "core", ""]);
