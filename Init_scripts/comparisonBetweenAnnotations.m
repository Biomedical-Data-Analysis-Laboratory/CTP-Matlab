...
compare_folder = "D:\Preprocessed-SUS2020_v2\INTER-OBSERVER VARIABILITY\FINALIZE_PM_Comparison_KK";
orig_folder = "D:\Preprocessed-SUS2020_v2\INTER-OBSERVER VARIABILITY\FINALIZE_PM_Comparison_LJ\";
name_workspace = "comparison_manual_annotation_Kathinka.mat";
% compare_folder = "D:\Preprocessed-SUS2020_v2\FINALIZE_PM_Comparison_LJ\";
% name_workspace = "comparison_manual_annotation_Liv.mat";
constants.TEST_SECRETDATASET = 1;

if ~exist(compare_folder+"_stats.mat", "file")
    stats = calculateMoreStats(compare_folder, constants, orig_folder);
else
    load(compare_folder+"_stats.mat",'stats');
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         orig_subfolder = strcat("D:\Preprocessed-SUS2020_v2\INTER-OBSERVER VARIABILITY\FINALIZE_PM_Comparison_LJ\", folder.name, "\");
% %         orig_folder = strcat("D:\Preprocessed-SUS2020_v2\FINALIZE_PM_Comparison_Kathinka\", folder.name, "\");
%     
%         for image = dir(orig_subfolder)'
